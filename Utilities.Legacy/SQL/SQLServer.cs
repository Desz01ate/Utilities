...
namespace Utilities.Legacy.SQL
{
    public class SQLServer : DatabaseConnector<SqlConnection, SqlParameter>
    {
        ...
        {
            return StaticDatabseConnector.ExecuteScalar<T, SqlConnection>(connectionString, sql, parameters, commandType);
        }
        [Obsolete("This method is deprecated and will be remove in the future, please use non-static method instead.")]
        ...
        {
            return await StaticDatabseConnector.ExecuteReaderAsync<T, SqlConnection>(connectionString, sql, parameters, objectBuilder, commandType);
        }
        [Obsolete("This method is deprecated and will be remove in the future, please use non-static method instead.")]
        ...
        {
            return await StaticDatabseConnector.ExecuteReaderAsync<SqlConnection>(connectionString, sql, parameters, commandType);
        }
        [Obsolete("This method is deprecated and will be remove in the future, please use non-static method instead.")]
        ...
        {
            return await StaticDatabseConnector.ExecuteNonQueryAsync<SqlConnection>(connectionString, sql, parameters, commandType);
        }
        [Obsolete("This method is deprecated and will be remove in the future, please use non-static method instead.")]
        ...
        public static int Insert<T>(string connectionString, T obj)
            where T : class, new()
        {
            return StaticDatabseConnector.Insert<T, SqlConnection, SqlParameter>(connectionString, obj);
        }
        [Obsolete("This method is deprecated and will be remove in the future, please use non-static method instead.")]
        ...
        public static int Update<T>(string connectionString, T obj)
            where T : class, new()
        {
            return StaticDatabseConnector.Update<T, SqlConnection, SqlParameter>(connectionString, obj);
        }
        [Obsolete("This method is deprecated and will be remove in the future, please use non-static method instead.")]
