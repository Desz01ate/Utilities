...
namespace Utilities.SQL
{
    ...
    public partial class DatabaseConnector : IDatabaseConnector
    {
        ...
        /// <summary>
        /// Indicate whether the internal worker should buffer reader execution.
        /// </summary>
        public bool AllowBuffer { get; set; } = false;
        ...
        public virtual IEnumerable<T> ExecuteReader<T>(string sql, IEnumerable<DbParameterStruct>? parameters = null, IDbTransaction? transaction = null, CommandType commandType = CommandType.Text) where T : class, new()
        {
            ...
            if (this.AllowBuffer) deferred = deferred.AsList();
            return deferred;
        }
        ...
        public virtual IEnumerable<dynamic> ExecuteReader(string sql, IEnumerable<DbParameterStruct>? parameters = null, IDbTransaction? transaction = null, CommandType commandType = CommandType.Text)
        {
            using var command = Connection.CreateCommand();
            command.CommandText = sql;
            command.Transaction = transaction as DbTransaction;
        ...
        public virtual async Task<IEnumerable<T>> ExecuteReaderAsync<T>(string sql, IEnumerable<DbParameterStruct>? parameters = null, IDbTransaction? transaction = null, CommandType commandType = CommandType.Text) where T : class, new()
        {
            using var command = Connection.CreateCommand();
            command.CommandText = sql;
            command.Transaction = transaction as DbTransaction;
        ...
        /// <param name="commandType">Type of SQL Command.</param>
        /// <returns>IEnumerable of dynamic object</returns>
        public virtual async Task<IEnumerable<dynamic>> ExecuteReaderAsync(string sql, IEnumerable<DbParameterStruct>? parameters = null, IDbTransaction? transaction = null, CommandType commandType = CommandType.Text)
        {
            using var command = Connection.CreateCommand();
