...
namespace Utilities
{
    public static class ImageProcessing
    {
        ...
        public static Image Resize(this Image image, int width, int height, GraphicsUnit graphicsUnit = GraphicsUnit.Pixel)
        {
            ...
            try
            {
                ...
                graphics.DrawImage(image, new Rectangle(0, 0, width, height), new Rectangle(0, 0, image.Width, image.Height), graphicsUnit);
                return output;
            }
            catch (Exception ex)
            {
